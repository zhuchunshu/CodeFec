        ...
        <div class="row justify-content">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3 class="card-title">编辑草稿-ID:{{ $data['id'] }}</h3>

                    <form action="{{ route('create.draft.post') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-12">
                            ...
                            <b>Or</b>
                            <button type="submit" value="yes" name="caogao" class="btn btn-red">保存</button>
                        </div>
                    </form>
                </div>
            </div>
