    ...
    <div class="container-xl">
        <div class="row row-cards">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group list-group-flush overflow-auto" style="max-height: 35rem">
                            <div class="list-group-item">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="{{route('public.friend.data',['id' => $value['id']])}}">
                                            <span class="avatar"
                                                style="background-image: url({{$value['logo']}})"></span>
                                        </a>
                                    </div>
                                    <div class="col text-truncate">
                                        <a href="{{route('public.friend.data',['id' => $value['id']])}}" class="text-body d-block">{{$value['name']}}</a>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">添加友链</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.links.friend.save') }}" accept-charset="UTF-8"
