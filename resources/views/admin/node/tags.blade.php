    ...
    <div class="container-xl">
        <div class="row row-cards">
                            ...
                            <div class="list-group-item">
                                <div class="row">
                                    <div class="col text-truncate">
                                        <a href="{{route('tags',['ename' => $value['ename']])}}" class="d-block badge bg-{{$value['color']}}">{{$value['name']}}</a>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">新增节点标签</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.node.tags.save') }}" accept-charset="UTF-8"
